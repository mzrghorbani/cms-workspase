...
HD_PWD='/home/mghorbani/workspace/kf_prj/kf-hls-work/proj/kf-hls/top/top.runs/KalmanUpdateHLS_IP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KalmanUpdateHLS_IP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KalmanUpdateHLS_IP.tcl
