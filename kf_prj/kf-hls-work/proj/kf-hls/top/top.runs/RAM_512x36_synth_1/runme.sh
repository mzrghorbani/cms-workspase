...
HD_PWD='/home/mghorbani/workspace/kf_prj/kf-hls-work/proj/kf-hls/top/top.runs/RAM_512x36_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_512x36.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_512x36.tcl
