...
CMSSW_BASE:=/home/mghorbani/workspace/CMSSW_10_2_5
...
SCONS_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/scons/1.2.0-omkpbe4
...
export CCACHE_BASEDIR:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/cmssw/CMSSW_10_2_5
endif
...
MADGRAPH5AMCATNLO_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/madgraph5amcatnlo/2.6.0-gnimlf7
...
MXNET_PREDICT_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/mxnet-predict/1.2.0-gnimlf
...
UTM_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/utm/utm_0.6.7-gnimlf
...
OPENLOOPS_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/openloops/1.3.1-omkpbe4
...
SHERPA_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/sherpa/2.2.4-gnimlf7
...
THEPEG_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/thepeg/2.1.1-gnimlf6
...
HERWIGPP_BASE:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/external/herwigpp/7.1.2-gnimlf8
...
LOCALTOP:=/home/mghorbani/workspace/CMSSW_10_2_5
SCRAM_TMP:=tmp
SCRAM_INIT_LOCALTOP:=/home/mghorbani/workspace/CMSSW_10_2_5
SCRAM_BUILDFILE:=BuildFile
RELEASETOP:=/cvmfs/cms.cern.ch/slc7_amd64_gcc700/cms/cmssw/CMSSW_10_2_5
SCRAM_INTlog:=logs
...
SCRAM_SOURCEDIR:=src
SCRAM_RTBOURNE_SET:=CMSSW:CMSSW_10_2_5:slc7_amd64_gcc700:V2_2_9_pre03:SRT_
SCRAM_CONFIGCHKSUM:=V05-07-32
SCRAM_LOOKUPDB_WRITE:=/cvmfs/cms.cern.ch
SCRAM_CXX11_ABI:=1
SCRAM_PROJECTVERSION:=CMSSW_10_2_5
